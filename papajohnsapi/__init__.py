...
def order(user_order):
    def __order__(user_order, user_driver, headless, real_number, real_street, real_city, real_state, real_zipcode, _first_name, _last_name, _email, _phonenum, credit_number, name_on_card, exp_month, exp_year, sec_code):
        print(_cash)
    ...
    def __order2__(user_order, user_driver, headless, real_number, real_street, real_city, real_state, real_zipcode, _first_name, _last_name, _email, _phonenum):
        type_of_user_order = str(type(user_order))
        if type_of_user_order != "<class 'list'>":
            raise TypeError('Your order must be a list.')
        else:
            ...
            try:
                ...
                pass
            cash_button = driver.find_element_by_xpath('//*[@id="cashPayment"]')
            cash_button.click()
            fname = driver.find_element_by_xpath('//*[@id="contact-firstname"]')
            fname.send_keys(_first_name)
            lname = driver.find_element_by_xpath('//*[@id="contact-lastname"]')
    ...
    if _cash and _headless:
        __order2__(user_order, driver, True, _number, _street, _city, _state, _zipcode, _first_name, _last_name, _email, _phone_number, )
    elif _cash and not _headless:
        __order2__(user_order, driver, False, _number, _street, _city, _state, _zipcode, _first_name, _last_name, _email, _phone_number, cash_option=True)
